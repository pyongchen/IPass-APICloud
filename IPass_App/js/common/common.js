...
/******/ 			script.src = __webpack_require__.p + "js/chunk/" + chunkId + ".chunk.js?" + "ae0763e5" + "";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $api = function $api(window) {
	  ...
	  */
		...
		var User = function User(userId, userName, userLogo, userSign) {
			this.userId = userId || "";
