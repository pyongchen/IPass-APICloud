...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/yong/Documents/IPASS/API_Cloud/src/src/js/app/activity/header-location.vue"
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-593afec0", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-593afec0", __vue_options__)
	  }
	})()}
	if (__vue_options__.functional) {console.error("[vue-loader] header-location.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  components: {
	    'header-location': __webpack_require__(85)
	  },
	  data: function data() {
	    return {
	      msg: '12321'
	  ...
	  mounted: function mounted() {
	    ...
	    var locationH = $api.dom('#location').offsetHeight;
	    api.setFrameAttr({
	      name: 'activity-header-' + 'location',
	      rect: {
	        x: 0,
	        y: headerH,
	        w: 'auto',
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/yong/Documents/IPASS/API_Cloud/src/src/componets/activity/header/location.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-738b3e2e", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-738b3e2e", __vue_options__)
	  }
	})()}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../../../node_modules/css-loader/index.js!./../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-738b3e2e!./../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./location.vue", function() {
				var newContent = require("!!./../../../../../node_modules/css-loader/index.js!./../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-738b3e2e!./../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./location.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _data = _activityHeaderData2.default.location; //
	//
	//
	//
	//
	...
	exports.default = {
	  ...
	  methods: {
	    //点击1级菜单的某项，打开2级菜单
	    open2: function open2(i) {
	      var key = this.location.first[i];
	      $api.dom('#location-second').style.left = '20%';
	      // 根据点击的1级菜单更换二级菜单
	      this.location.second = _data.loc[key];
	    ...
	    //点击2级菜单的某项，打开3级菜单
	    open3: function open3(i) {
	      var key = this.location.second[i];
	      $api.dom('#location-third').style.left = '50%';

	      // 根据点击的2级菜单更换3级菜单
	      this.location.third = _data.place[key];

	      // 改变2级菜单点击项的样式
	      var lis = $api.domAll('.second');
	      for (var j = 0; j < lis.length; j++) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, _vm._l((_vm.location.first), function(t, i) {
	    return _c('li', {
	      staticClass: "first",
	      on: {
	  ...
	  }, _vm._l((_vm.location.second), function(t, i) {
	    return _c('li', {
	      staticClass: "second",
	      on: {
	        "click": function($event) {
	  ...
	  }, _vm._l((_vm.location.third), function(t, i) {
	    return _c('li', {
	      staticClass: "third",
	      on: {
	        "click": function($event) {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-738b3e2e", module.exports)
	  }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('body', [_c('header-location')], 1)
	},staticRenderFns: []}
	module.exports.render._withStripped = true
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-593afec0", module.exports)
	  }
	}
